    ...
    <body>
        ...
        <div id="banner">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="2_10_2_SEGURANCA_PUBLICALinkTabelas.php">2.10.2 - SEGURANÇA PÚBLICA</a></li>
                <li class="breadcrumb-item active"> 2.10.2.1 - Número de homicídios</li>
            </ol>
            ...
            <div id="quadroConteudo">
                ...
                <div id="conteudo">
                    <div id="texto">
                        ...
                        <?php include '2_10_2_1_Homic_obt_suiHTM.php'; ?>
