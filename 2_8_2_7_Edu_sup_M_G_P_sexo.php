    ...
    <body>
        ...
        <div id="banner">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="2_8_2_EDUCACAO_SUPERIORLinkTabelas.php"> 2.8.2 - EDUCAÇÃO SUPERIOR</a></li>
                <li class="breadcrumb-item active">2.8.2.7 - Matrículas em cursos de graduação presencial da educação superior</li>
            </ol>
            ...
            <div id="quadroConteudo">
                ...
                <div id="conteudo">
                    <div id="texto">
                        ...
                        <?php include '2_8_2_7_Edu_sup_M_G_P_sexoHTM.php'; ?>
