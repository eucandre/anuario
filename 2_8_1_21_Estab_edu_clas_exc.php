    ...
    <body>
        ...
        <div id="banner">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> 2.8.1.21 -Número de Estabelecimentos na Educação Especial com Classes Exclusivas</li>
            </ol>
            ...
            <div id="quadroConteudo">
                ...
                <div id="conteudo">
                    <div id="texto">
                        ...
                        <?php include '2_8_1_21_Estab_edu_clas_excHTM.php'; ?>
